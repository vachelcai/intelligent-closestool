...
extern void washLoop(void const * argument);
...
int main(void)
{
  ...
  //osThreadDef(ButtonTask, buttonLoop, osPriorityHigh, 0, 64);
  //ButtonTaskHandle = osThreadCreate(osThread(ButtonTask), NULL);

  /* definition and creation of wash */
  //osThreadDef(wash, washLoop, osPriorityNormal, 0, 200);
  //washHandle = osThreadCreate(osThread(wash), NULL);
